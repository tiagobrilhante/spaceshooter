...
repeat(vida)
{
	draw_sprite_ext(spr_player_teste2, 0, 40 + _espaco*_multiplicador , 663, 0.2, 0.2, 0 , c_white, 1);
...
repeat(escudos)
{
	draw_sprite_ext(spr_escudo, 2 , 40 + _espaco*_multiplicador , 689, 0.17, 0.17, 0 , c_white, 1);
